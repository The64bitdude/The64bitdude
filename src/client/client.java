...
import java.io.*;
public class client extends JFrame implements ActionListener,KeyListener,ListSelectionListener{
	...
	public client(String ips,int ports,String name) throws IOException, ClassNotFoundException {
		super("chatClient");
		setSize(500,500);
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		frm.setVisible(true);
		frm.dispose();
		client e = new client(ips,ports,name);
	}
